...
namespace GensouSakuya.QQBot.Platform.GoCqhttp.LiveChat
{
    public class QQHelper
    {
        ...
        private ILogger<QQHelper> _logger;
        private IServiceProvider _serviceProvider;
        public QQHelper(IServiceProvider serviceProvider, WebsocketSession session, ILogger<QQHelper> logger)
        {
        ...
        public async Task SendDanmu(object sender, GuildMessage msg)
        {
            try
            {
            ...
            {
                _logger.LogError(ex, "send danmu error");
            }
        }
